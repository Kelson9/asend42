...
url: string
  ...
  getPublicPost(): Observable<UPost[]> {
    return this.http.get<UPost[]>(`https://asend-185ba-default-rtdb.firebaseio.com/post/public.json`)

  }

  Create_Testimony(postdata: {}) {
    this.http.post(
      `https://asend-185ba-default-rtdb.firebaseio.com/testimony.json`,
      postdata
    )
      .subscribe(responseData => {
  ...
  getTestimony():Observable<Testimony[]> {
    return this.http.get<Testimony[]>(`https://asend-185ba-default-rtdb.firebaseio.com/testimony.json`)

  }
  getAllData2() {
    let z= this.http.get<Testimony[]>(`https://asend-185ba-default-rtdb.firebaseio.com/testimony.json`)
    return z;
  ...
  getPrivatePost(): Observable<UPost[]> {
    return this.http.get<UPost[]>(`https://asend-185ba-default-rtdb.firebaseio.com/post/private.json`)

  }

  getAllData() {
    let x = this.http.get<UPost[]>(`https://asend-185ba-default-rtdb.firebaseio.com/post/public.json`)
    let y = this.http.get<UPost[]>(`https://asend-185ba-default-rtdb.firebaseio.com/post/private.json`)
    return forkJoin(x, y)
  ...
  getDemo1() {
    this.http.get<UPost[]>(`https://asend-185ba-default-rtdb.firebaseio.com/post/private.json`)
      .pipe(
        map(responseData => {
  ...
  getDemo2() {
    this.http.get<UPost[]>(`https://asend-185ba-default-rtdb.firebaseio.com/post/public.json`)
      .pipe(
        map(responseData => {
          const postsArray: UPost[] = [];
          for (const key in responseData) {
